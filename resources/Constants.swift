...
struct Constants {
    ...
    static let retainedCardMsg = "El banco ha solicitado que la tarjeta sea retenida, contacte al banco"
    ...
    static let failAddCardDefaultMsg  = "Ocurrió un error al registrar la tarjeta"
    ...
    static let missmatchPasswordsMsg = "La contraseña no coincide"
    static let errorInvalidEmailsMsg = "Debe ingresar un email valido"
